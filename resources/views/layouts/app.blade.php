...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .sidebar { transform: translateX(-16rem); }
        ...
        #notificationDropdown { animation: slideDown 0.3s ease-out; }
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <script>
        ...
        function toggleNotificationDropdown(){
            ...
            if(notificationDropdownOpen){ dropdown.classList.add('hidden'); notificationDropdownOpen=false; }
            else{ dropdown.classList.remove('hidden'); notificationDropdownOpen=true; }
        }
        ...
        window.addEventListener('resize', function(){
            ...
            if(window.innerWidth >= 768){
                ...
                backdrop.classList.remove('show');
                document.body.style.overflow='';
                if(!sidebar.classList.contains('sidebar-closed')) mainContent.classList.remove('main-content-expanded');
            } else {
                sidebar.classList.remove('sidebar-closed');
                mainContent.classList.remove('main-content-expanded');
                if(!sidebar.classList.contains('mobile-open')) backdrop.classList.remove('show');
            }
        });
